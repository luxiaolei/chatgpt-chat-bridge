...
cp "$ROOT/src/local-query.py" "$SHARE_DIR/local-query.py"
cp "$ROOT/src/ask-wrapper.py" "$SHARE_DIR/ask-wrapper.py"
cp "$ROOT/src/ego-runner.py" "$SHARE_DIR/ego-runner.py"
